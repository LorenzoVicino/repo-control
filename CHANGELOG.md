...
- Call the strictest repository state **In sync** rather than **Ready**: it counts only repositories that are clean, synced and have nothing to push, while the dashboard headline already calls a repository ready as soon as it is clean and not behind. Two different numbers labelled "ready" on one page was a contradiction.
