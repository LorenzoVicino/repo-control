export const en = {
  ...
  "invitation": "New here? Check your tools and open your first repository.",
  "settingsDescription": "Review the workspace, detected local tools and where to begin.",
  "start": "Set up workspace",
  "reopen": "Open setup guide",
  "skip": "Skip setup",
  "next": "Continue",
  "back": "Back",
  "finish": "Open repository",
  "done": "Go to dashboard",
  "workspace": "Confirm your workspace",
  "tools": "Check your tools",
  "repository": "Choose your first repository",
  "folder": "Workspace folder",
  "browse": "Browse folders",
  "scan": "Scan folder",
  "scanning": "Scanning repositories…",
  "count": "{{count}} repositories found",
  "empty": "No repositories found. Choose a folder containing Git repositories, or continue to the dashboard.",
  "optional": "Only Git is required. You can install optional tools later and retry this check.",
  "available": "Available",
  "missing": "Not found",
  "unreachable": "Installed · Docker daemon not reachable",
  "required": "Required",
  "retry": "Check again",
  "hint": "Open Changes to inspect files, or press Ctrl+P to jump to another repository.",
  "pathHint": "Use a folder on the machine running repo-control. You can paste a path if the folder picker is unavailable.",
  "error": "Setup could not finish. Please try again.",
  "checking": "Checking local tools…",
  "choose": "Repository",
  "demo": "Demo workspace · Changes stay in this browser",
  "reset": "Reset demo",
  "local": "Run on your machine",
  "copy": "Copy command",
  "copied": "Copied",
  "localHint": "Install Node.js and Git, then run this command in your workspace folder. Local tools and agent resume are available in the installed app.",
  "demoHint": "Explore fictional repositories, inspect a diff, stage and commit a change, or preview the sample automation.",
  "gitMissing": "Git was not found in the server PATH. Install Git and restart repo-control to inspect repositories."
},
  common: {
  ...
  appearance: {
    palettes: {
      white: { label: "White", description: "Neutral light theme, paper ground with an indigo accent" },
      black: { label: "Black", description: "Neutral dark theme, graphite ground with a violet accent" },
      red: { label: "Red", description: "Warm dark theme, charcoal ground with an ember accent" },
      blue: { label: "Blue", description: "Cool dark theme, navy ground with a sky accent" },
      green: { label: "Green", description: "Natural dark theme, forest ground with a mint accent" }
    },
    fontScales: {
  ...
  dashboard: {
    ...
    home: {
      headline: {
        empty: "No repository in this workspace yet",
        allClear_one: "The {{count}} repository is in order",
        allClear_other: "All {{count}} repositories are in order",
        attention: "{{attention}} of {{total}} repositories need attention"
      },
      ...
      edit: {
        ...
        unavailable: "Saved preferences are unavailable, so layout changes cannot be stored right now.",
        hint: "Drag a widget to move it. Use the controls above each widget to change its size, move it with the keyboard or hide it. Hidden widgets can be brought back from the list below the grid.",
        hiddenWidgets: "Hidden widgets",
        allVisible: "Every widget is shown.",
        show: "Show {{widget}}",
        hide: "Hide {{widget}}",
        moveEarlier: "Move {{widget}} earlier",
        moveLater: "Move {{widget}} later",
        sizeOf: "Size of {{widget}}",
        sizes: { small: "Small", medium: "Medium", large: "Large" },
        sizeShort: { small: "S", medium: "M", large: "L" },
        moved: "{{widget}} moved to position {{position}} of {{total}}",
        resized: "{{widget}} set to {{size}}",
        hidden: "{{widget}} hidden",
        shown: "{{widget}} shown",
        reset: "Default layout restored"
      }
    },
    widgets: {
      shared: {
      ...
      attention: {
        ...
        meta_one: "{{count}} item",
        meta_other: "{{count}} items",
        empty: "Nothing needs you right now",
        emptyHint: "Repositories with local changes or commits to pull, containers reporting unhealthy and automations that did not finish appear here.",
        noWorkspace: "No workspace scanned",
        noWorkspaceHint: "Select a workspace folder to start triaging its repositories.",
        open: "Open {{name}}",
        severityChart: "Items by severity: {{description}}",
        severity: {
          critical_one: "{{count}} critical",
          critical_other: "{{count}} critical",
          warning_one: "{{count}} warning",
          warning_other: "{{count}} warnings",
          action_one: "{{count}} action needed",
          action_other: "{{count}} actions needed",
          info_one: "{{count}} to publish",
          info_other: "{{count}} to publish"
        },
        showAll_one: "Show {{count}} more in Repositories",
        showAll_other: "Show {{count}} more in Repositories",
        reasons: {
          containersUnhealthy_one: "{{count}} unhealthy container",
          containersUnhealthy_other: "{{count}} unhealthy containers",
          containersRestarting_one: "{{count}} container starting",
          containersRestarting_other: "{{count}} containers starting",
          runFailed: "Last run failed {{time}}",
          runInterrupted: "Last run was interrupted {{time}}",
          behind_one: "{{count}} commit to pull",
          behind_other: "{{count}} commits to pull",
          changes_one: "{{count}} local change",
          changes_other: "{{count}} local changes",
          staged_one: "{{count}} staged",
          staged_other: "{{count}} staged",
          modified_one: "{{count}} modified",
          modified_other: "{{count}} modified",
          untracked_one: "{{count}} new",
          untracked_other: "{{count}} new",
          ahead_one: "{{count}} commit to push",
          ahead_other: "{{count}} commits to push",
          notClean: "Working tree not clean"
        }
      },
      workspace: {
        title: "Workspace",
        ...
        distribution: "Repository states: {{description}}",
        states: {
        ...
        localChanges_one: "{{count}} changed file across the workspace",
        localChanges_other: "{{count}} changed files across the workspace",
        scanned: "Scanned {{time}}",
        scanning: "scanning now",
        changeConcentration: "Where the changes are",
        changeLegend: "Change kinds",
        changeKinds: { staged: "Staged", modified: "Modified", untracked: "New" },
        treesAligned: "Every working tree is clean.",
        openChanges: "Open {{name}}, {{count}} changed files",
        empty: "No workspace folder",
        emptyHint: "Point repo-control at a folder and every Git repository inside it appears here.",
      ...
      runtime: {
        ...
        open: "Open",
        loading: "Reading Docker containers",
        unavailable: "Docker not detected",
        unavailableHint: "Install or start Docker to see running containers here.",
        none: "No container running",
        noneHint: "Start a Compose stack from a repository's Docker tab and it appears here.",
        running_one: "{{count}} container running",
        running_other: "{{count}} containers running",
        healthy_one: "{{count}} healthy",
        healthy_other: "{{count}} healthy",
        unhealthy_one: "{{count}} unhealthy",
        unhealthy_other: "{{count}} unhealthy",
        restarting_one: "{{count}} starting",
        restarting_other: "{{count}} starting",
      ...
      resume: {
        ...
        emptyHint: "Repositories you open appear here, followed by favorites and the most recently committed ones.",
        lastCommit: "committed {{time}}",
      ...
      chats: {
        ...
        all: "All",
        resume: "Resume",
        resumeAria: "Resume the conversation {{title}} in a terminal",
        loading: "Scanning the local agent histories…",
        empty: "No conversation found",
        emptyHint: "Start Codex, Claude Code or Gemini CLI inside a repository of this workspace and its history appears here.",
        activityTitle: "Conversations per day, last {{days}} days",
        today_one: "{{count}} today",
        today_other: "{{count}} today",
        activeDays_one: "{{count}} active day",
        activeDays_other: "{{count}} active days",
        activityAria: "Conversations touched per day over the last {{days}} days, {{count}} in total"
      },
      automations: {
        title: "Automations",
        workflowCount_one: "{{count}} workflow",
        workflowCount_other: "{{count}} workflows",
        activeCount_one: "{{count}} running",
        activeCount_other: "{{count}} running",
        open: "Open",
        loading: "Reading workflow runs",
        error: "Unable to read the automations",
        empty: "No workflow yet",
        emptyHint: "Turn a repeated fetch, pull or Docker restart across repositories into a workflow you can preview and run.",
        create: "Create a workflow",
        noRuns: "No run yet",
        noRunsHint: "Runs and their outcome appear here as soon as a workflow is executed.",
        openRun: "Open the run of {{name}}",
        startedAt: "started {{time}}",
        dryRun: "dry run {{time}}",
        chartTitle_one: "Duration of the last run",
        chartTitle_other: "Duration of the last {{count}} runs",
        chartMax: "longest {{duration}}",
        chartAria_one: "Duration of the last run, coloured by outcome",
        chartAria_other: "Duration of the last {{count}} runs, coloured by outcome"
      },
      shortcuts: {
        title: "Shortcuts",
        search: "Find a repository",
        workspace: "Change workspace folder",
        rescan: "Rescan the workspace",
      ...
      favorites: {
        ...
        emptyHint: "Star the repositories you check most often and they are one click away here.",
        browse: "Browse repositories"
      }
    }
  },
  ...
  preferenceState: {
    ...
    layoutTitle: "Dashboard layout was not saved",
    layoutDescription: "Your arrangement stays on screen until the page reloads. Retry to store it.",
    retry: "Retry",
    retrying: "Retrying…",
    dismiss: "Dismiss",
  ...
  settings: {
    ...
    general: "General",
    generalDescription: "Interface preferences",
    ...
    paletteDescription: "Choose a complete palette for surfaces and accents, also available from the profile menu.",
...
export const it: TranslationSchema<typeof en> = {
  setup: {
  "title": "Benvenuto nel tuo workspace",
  "invitation": "Prima volta qui? Controlla gli strumenti e apri il tuo primo repository.",
  "settingsDescription": "Rivedi il workspace, gli strumenti locali rilevati e da dove iniziare.",
  "start": "Configura workspace",
  "reopen": "Apri guida iniziale",
  "skip": "Salta configurazione",
  "next": "Continua",
  "back": "Indietro",
  "finish": "Apri repository",
  "done": "Vai alla dashboard",
  "workspace": "Conferma il workspace",
  "tools": "Controlla gli strumenti",
  "repository": "Scegli il primo repository",
  "folder": "Cartella del workspace",
  "browse": "Sfoglia cartelle",
  "scan": "Scansiona cartella",
  "scanning": "Scansione dei repository…",
  "count": "{{count}} repository trovati",
  "empty": "Nessun repository trovato. Scegli una cartella contenente repository Git oppure continua alla dashboard.",
  "optional": "Solo Git è necessario. Puoi installare gli strumenti opzionali in seguito e ripetere il controllo.",
  "available": "Disponibile",
  "missing": "Non trovato",
  "unreachable": "Installato · Demone Docker non raggiungibile",
  "required": "Necessario",
  "retry": "Controlla di nuovo",
  "hint": "Apri Modifiche per esaminare i file, oppure premi Ctrl+P per passare a un altro repository.",
  "pathHint": "Usa una cartella sul computer che esegue repo-control. Puoi incollare un percorso se il selettore non è disponibile.",
  "error": "Configurazione non completata. Riprova.",
  "checking": "Controllo degli strumenti locali…",
  "choose": "Repository",
  "demo": "Workspace demo · Le modifiche restano in questo browser",
  "reset": "Ripristina demo",
  "local": "Esegui sul tuo computer",
  "copy": "Copia comando",
  "copied": "Copiato",
  "localHint": "Installa Node.js e Git, poi esegui questo comando nella cartella del workspace. Gli strumenti locali e la ripresa delle sessioni sono disponibili nell'app installata.",
  "demoHint": "Esplora repository di esempio, esamina un diff, prepara e crea un commit oppure visualizza l'anteprima dell'automazione.",
  "gitMissing": "Git non è stato trovato nel PATH del server. Installa Git e riavvia repo-control per esaminare i repository."
},
  common: {
    repository: "Repository",
    workspace: "Workspace",
  ...
  appearance: {
    palettes: {
      white: { label: "Bianco", description: "Tema chiaro neutro, fondo carta con accento indaco" },
      black: { label: "Nero", description: "Tema scuro neutro, fondo grafite con accento viola" },
      red: { label: "Rosso", description: "Tema scuro caldo, fondo carbone con accento brace" },
      blue: { label: "Blu", description: "Tema scuro freddo, fondo navy con accento cielo" },
      green: { label: "Verde", description: "Tema scuro naturale, fondo foresta con accento menta" }
    },
    fontScales: {
  ...
  dashboard: {
    ...
    home: {
      headline: {
        empty: "Nessun repository in questo workspace",
        allClear_one: "Il repository è in ordine",
        allClear_other: "Tutti i {{count}} repository sono in ordine",
        attention: "{{attention}} di {{total}} repository richiedono attenzione"
      },
      noWorkspace: "Nessuna cartella workspace selezionata",
      edit: {
        customize: "Personalizza",
        done: "Fine",
        resetAction: "Ripristina layout",
        unavailable: "Le preferenze salvate non sono disponibili, quindi le modifiche al layout non possono essere memorizzate adesso.",
        hint: "Trascina un widget per spostarlo. Usa i comandi sopra ciascun widget per cambiarne la dimensione, spostarlo con la tastiera o nasconderlo. I widget nascosti si recuperano dall’elenco sotto la griglia.",
        hiddenWidgets: "Widget nascosti",
        allVisible: "Tutti i widget sono visibili.",
        show: "Mostra {{widget}}",
        hide: "Nascondi {{widget}}",
        moveEarlier: "Sposta {{widget}} prima",
        moveLater: "Sposta {{widget}} dopo",
        sizeOf: "Dimensione di {{widget}}",
        sizes: { small: "Piccolo", medium: "Medio", large: "Grande" },
        sizeShort: { small: "S", medium: "M", large: "L" },
        moved: "{{widget}} spostato in posizione {{position}} di {{total}}",
        resized: "{{widget}} impostato su {{size}}",
        hidden: "{{widget}} nascosto",
        shown: "{{widget}} mostrato",
        reset: "Layout predefinito ripristinato"
      }
    },
    widgets: {
      shared: {
      ...
      attention: {
        title: "Da gestire",
        meta_one: "{{count}} elemento",
        meta_other: "{{count}} elementi",
        empty: "Niente richiede il tuo intervento",
        emptyHint: "Qui compaiono i repository con modifiche locali o commit da scaricare, i container segnalati unhealthy e le automazioni non concluse.",
        noWorkspace: "Nessun workspace scansionato",
        noWorkspaceHint: "Seleziona una cartella workspace per iniziare il triage dei suoi repository.",
        open: "Apri {{name}}",
        severityChart: "Elementi per gravità: {{description}}",
        severity: {
          critical_one: "{{count}} critico",
          critical_other: "{{count}} critici",
          warning_one: "{{count}} avviso",
          warning_other: "{{count}} avvisi",
          action_one: "{{count}} da gestire",
          action_other: "{{count}} da gestire",
          info_one: "{{count}} da pubblicare",
          info_other: "{{count}} da pubblicare"
        },
        showAll_one: "Mostra un altro in Repository",
        showAll_other: "Mostra altri {{count}} in Repository",
        reasons: {
          containersUnhealthy_one: "{{count}} container unhealthy",
          containersUnhealthy_other: "{{count}} container unhealthy",
          containersRestarting_one: "{{count}} container in avvio",
          containersRestarting_other: "{{count}} container in avvio",
          runFailed: "Ultima esecuzione fallita {{time}}",
          runInterrupted: "Ultima esecuzione interrotta {{time}}",
          behind_one: "{{count}} commit da scaricare",
          behind_other: "{{count}} commit da scaricare",
          changes_one: "{{count}} modifica locale",
          changes_other: "{{count}} modifiche locali",
          staged_one: "{{count}} staged",
          staged_other: "{{count}} staged",
          modified_one: "{{count}} modificato",
          modified_other: "{{count}} modificati",
          untracked_one: "{{count}} nuovo",
          untracked_other: "{{count}} nuovi",
          ahead_one: "{{count}} commit da pubblicare",
          ahead_other: "{{count}} commit da pubblicare",
          notClean: "Working tree non pulito"
        }
      },
      workspace: {
        title: "Workspace",
        repositoryCount_one: "{{count}} repository",
        repositoryCount_other: "{{count}} repository",
        distribution: "Stato dei repository: {{description}}",
        states: {
          changes: "Con modifiche locali",
          behind: "Indietro rispetto al remoto",
          ahead: "Avanti rispetto al remoto",
          inSync: "Sincronizzati"
        },
        localChanges_one: "{{count}} file modificato nel workspace",
        localChanges_other: "{{count}} file modificati nel workspace",
        scanned: "Scansione {{time}}",
        scanning: "in corso",
        changeConcentration: "Dove sono le modifiche",
        changeLegend: "Tipi di modifica",
        changeKinds: { staged: "Staged", modified: "Modificati", untracked: "Nuovi" },
        treesAligned: "Tutti i working tree sono puliti.",
        openChanges: "Apri {{name}}, {{count}} file modificati",
        empty: "Nessuna cartella workspace",
        emptyHint: "Indica a repo-control una cartella e ogni repository Git al suo interno comparirà qui.",
      ...
      runtime: {
        ...
        open: "Apri",
        loading: "Lettura dei container Docker",
        unavailable: "Docker non rilevato",
        unavailableHint: "Installa o avvia Docker per vedere qui i container in esecuzione.",
        none: "Nessun container in esecuzione",
        noneHint: "Avvia uno stack Compose dalla tab Docker di un repository e comparirà qui.",
        running_one: "{{count}} container in esecuzione",
        running_other: "{{count}} container in esecuzione",
        healthy_one: "{{count}} healthy",
        healthy_other: "{{count}} healthy",
        unhealthy_one: "{{count}} unhealthy",
        unhealthy_other: "{{count}} unhealthy",
        restarting_one: "{{count}} in avvio",
        restarting_other: "{{count}} in avvio",
        containerCount_one: "{{count}} container",
      ...
      resume: {
        ...
        recentCount_one: "{{count}} recente",
        recentCount_other: "{{count}} recenti",
        all: "Tutti",
        open: "Apri {{name}}",
        empty: "Nessun repository aperto finora",
        emptyHint: "I repository che apri compaiono qui, seguiti dai preferiti e da quelli con i commit più recenti.",
        lastCommit: "commit {{time}}",
        sources: { favorite: "Preferito" }
      },
      chats: {
        ...
        all: "Tutte",
        resume: "Riprendi",
        resumeAria: "Riprendi la conversazione {{title}} in un terminale",
        loading: "Scansione delle cronologie agent locali…",
        empty: "Nessuna conversazione trovata",
        emptyHint: "Avvia Codex, Claude Code o Gemini CLI in un repository di questo workspace e la sua cronologia comparirà qui.",
        activityTitle: "Conversazioni al giorno, ultimi {{days}} giorni",
        today_one: "{{count}} oggi",
        today_other: "{{count}} oggi",
        activeDays_one: "{{count}} giorno attivo",
        activeDays_other: "{{count}} giorni attivi",
        activityAria: "Conversazioni toccate al giorno negli ultimi {{days}} giorni, {{count}} in totale"
      },
      automations: {
        title: "Automazioni",
        workflowCount_one: "{{count}} workflow",
        workflowCount_other: "{{count}} workflow",
        activeCount_one: "{{count}} in esecuzione",
        activeCount_other: "{{count}} in esecuzione",
        open: "Apri",
        loading: "Lettura delle esecuzioni",
        error: "Impossibile leggere le automazioni",
        empty: "Nessun workflow",
        emptyHint: "Trasforma un fetch, un pull o un riavvio Docker ripetuto su più repository in un workflow da provare ed eseguire.",
        create: "Crea un workflow",
        noRuns: "Nessuna esecuzione",
        noRunsHint: "Le esecuzioni e il loro esito compaiono qui appena un workflow viene lanciato.",
        openRun: "Apri l’esecuzione di {{name}}",
        startedAt: "avviata {{time}}",
        dryRun: "dry run {{time}}",
        chartTitle_one: "Durata dell’ultima esecuzione",
        chartTitle_other: "Durata delle ultime {{count}} esecuzioni",
        chartMax: "massima {{duration}}",
        chartAria_one: "Durata dell’ultima esecuzione, colorata per esito",
        chartAria_other: "Durata delle ultime {{count}} esecuzioni, colorata per esito"
      },
      shortcuts: {
        title: "Scorciatoie",
        search: "Trova un repository",
        workspace: "Cambia cartella workspace",
        rescan: "Riscansiona il workspace",
        rescanning: "Scansione in corso…"
      },
      favorites: {
        title: "Preferiti",
        savedCount_one: "{{count}} salvato",
        ...
        emptyHint: "Segna con la stella i repository che controlli più spesso e li avrai a un click da qui.",
        browse: "Sfoglia i repository"
      }
    }
  },
  loading: {
  ...
  preferenceState: {
    ...
    layoutTitle: "Layout della dashboard non salvato",
    layoutDescription: "La disposizione resta a schermo fino al prossimo ricaricamento. Riprova per memorizzarla.",
    retry: "Riprova",
    retrying: "Nuovo tentativo…",
    dismiss: "Ignora",
  ...
  settings: {
    ...
    general: "Generali",
    generalDescription: "Preferenze di interfaccia",
    ...
    paletteDescription: "Scegli una palette completa per superfici e accenti, disponibile anche dal menu profilo.",
